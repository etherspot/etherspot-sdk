...
async function main(): Promise<void> {
  ...
  logger.log('gateway batch approval transaction', await sdk.batchExecuteAccountTransaction({
  ...
  logger.log('gateway batch transfer token transaction', await sdk.batchExecuteAccountTransaction({to,data:data,value}));
